...
SERVICE_CONTROLLER_IMAGE := quay.io/rhn-support-rjauhari/service-controller
CONTROLLER_PODMAN_IMAGE := quay.io/rhn-support-rjauhari/controller-podman
SITE_CONTROLLER_IMAGE := quay.io/rhn-support-rjauhari/site-controller
CONFIG_SYNC_IMAGE := quay.io/rhn-support-rjauhari/config-sync
FLOW_COLLECTOR_IMAGE := quay.io/rhn-support-rjauhari/flow-collector
